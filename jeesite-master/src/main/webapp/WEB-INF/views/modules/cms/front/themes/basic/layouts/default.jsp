...
<body>
	...
	<div  class="container">
	   <div style="width:100%;height:45px;background-color:azure;" > 您好，欢迎来到${site.title}！</div>
       <div style="width: 100%;height: 90px;padding: 20px 0px 15px;background: #fff;margin: 0 auto;">
                 <div style="float:left">
                      <c:choose>
			   			<c:when test="${not empty site.logo}">
			   				<img  style="width:249px" alt="${site.title}" src="${site.logo}" class="container" onclick="location='${ctx}/index-${site.id}${fns:getUrlSuffix()}'">
			   			</c:when>
