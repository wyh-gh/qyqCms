...
<body>
	...
	<form:form id="inputForm" modelAttribute="article" action="${ctx}/cms/article/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
                <input type="hidden" id="image" name="image" value="${article.imageSrc}" />${article.imageSrc}
				<sys:ckfinder input="image" type="thumb" uploadPath="/cms/article" selectMultiple="false"/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">首页轮播图:</label>
			<div class="controls">
                <input type="hidden" id="homeImage" name="homeImage" value="${article.homeImageSrc}" />${article.homeImageSrc}
				<sys:ckfinder input="homeImage" type="images" uploadPath="/cms/article" selectMultiple="false"/>
			</div>
		</div>
		<div class="control-group">
